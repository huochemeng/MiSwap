...
import (
	...
	logTypes "MiSwap/base/chain/types"
)
...
func (s *Service) BlockTimeByNumber(ctx context.Context, blockNum *big.Int) (uint64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "failed to get block header")
	}
...
func (s *Service) BlockNumber() (uint64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "failed to get evm block number")
	}
...
func (s *Service) BlockWithTxs(ctx context.Context, blockNumber uint64) (interface{}, error) {
	...
	if err != nil {
		return nil, errors.Wrap(err, "failed to get evm block")
	}
